...
exports.getArchetypeDescription = getArchetypeDescription;
function parseRoleplayStats(character) {
...
exports.parseRoleplayStats = parseRoleplayStats;
...
function getBackstory(character) {
    const backstoryType = (0, functions_2.random)(1, 3);
    let backstory = "";
...
exports.getBackstory = getBackstory;
function getTabloidPrompt(character) {
...
function getDnDAdventurePrompt(character) {
    const stats = parseRoleplayStats(character);
    const backstory = `S ::=
...
function getExcerptPrompt(character) {
    const stats = parseRoleplayStats(character);
    const backstory = `
...
*/
function parsePromptTags(prompt, character) {
    return (0, functions_1.replaceTags)(prompt, character)
