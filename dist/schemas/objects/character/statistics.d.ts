...
export declare const additionalStringTypes: z.ZodEnum<["text", "translatableText", "nextLine", "endOfParagraph", "numberAsWord", "ordinal", "rollableNumberWithSign", "feet", "-feet", "ft", "range/rangeMax", "range", "reach", "resource", "tag", "rollableDice", "rollableDiceDamage", "rollableDiceDamageEnchantment"]>;
...
export declare const descriptionPartObject: z.ZodObject<{
    ...
    type?: "damageType" | "range" | "type" | "alignment" | "armor" | "background" | "class" | "condition" | "conditionImmunity" | "immunity" | "item" | "language" | "pronouns" | "race" | "resistance" | "savingThrow" | "sense" | "size" | "skill" | "speed" | "spell" | "subtype" | "template" | "trait" | "vulnerability" | "weapon" | "reach" | "tag" | "text" | "translatableText" | "nextLine" | "endOfParagraph" | "numberAsWord" | "ordinal" | "rollableNumberWithSign" | "feet" | "-feet" | "ft" | "range/rangeMax" | "resource" | "rollableDice" | "rollableDiceDamage" | "rollableDiceDamageEnchantment" | undefined;
