...
export declare const additionalStringTypes: z.ZodEnum<["text", "translatableText", "nextLine", "endOfParagraph", "text", "numberWithSign", "numberAsWord", "ft", "rollableNumberWithSign", "feet", "resource", "tag", "rollableDice"]>;
...
export declare const statisticsObject: z.ZodObject<{
    ...
    legendaryActionsIntro: z.ZodOptional<z.ZodArray<z.ZodObject<{
        string: z.ZodString;
        array: z.ZodArray<z.ZodObject<{
            string: z.ZodString;
            number: z.ZodOptional<z.ZodNumber>;
